...
//HOME MANAGER
public class Home_Role3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_role3);
        ...
        btn_akun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent a = new Intent(Home_Role3.this, Profile.class);
                startActivity(a);
                finish();
            }
        });
        ...
        btn_master.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Home_Role3.this);
        ...
        btn_banding.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a = new Intent(Home_Role3.this, Laporan.class);
                startActivity(a);
                finish();
            }
        });
        ...
        btn_about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a = new Intent(Home_Role3.this, About.class);
                startActivity(a);
                finish();
            }
        });
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(Home_Role3.this);
        alert.setMessage("Keluar dari aplikasi ?")
                .setPositiveButton("Keluar", new DialogInterface.OnClickListener()                 {

                    public void onClick(DialogInterface dialog, int which) {

                        Home_Role3.super.onBackPressed();
                        finish();
                        finishAffinity();
